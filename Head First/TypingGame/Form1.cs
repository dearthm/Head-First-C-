...
namespace TypingGame
{
    public partial class Form1 : Form
    {
        ...
        {
            // if the user pressed a key that's inn the Listbox, remove it
            // and make the game a little faster
            if (listBox1.Items.Contains(e.KeyCode))
            {
                ...
                //The user press a correct key, so update the Stats object
            ...
            else
            {
                ...
                // by calling it's Update method with the argument 'false'
                stats.Update(false);
            }
